...
const column = {
  ...
  title:
    'u-font--primary--xl u-space--zero u-flex--justify-center u-theme--color--dark'
};
...
const feature = {
  ...
  content:
    'u-spacing u-padding--bottom u-padding--top l-grid-item u-theme--border-color--darker--left u-theme--background-color--darker u-theme--color--lighter',
  image: 'u-padding--zero--sides l-grid-item',
  title:
    'u-color--white u-font-weight--bold u-space--zero u-theme--color--lighter',
...
const featuredNews = {
  ...
  content:
    'u-spacing u-padding--left u-flex--justify-start l-grid-item l-grid-item--s--4-col l-grid-item--l--4-col',
...
const archiveHome = {
  ...
  content:
    'u-spacing u-border--left u-flex--justify-start l-grid-item--4-col l-grid-item--m--3-col l-grid-item--l--3-col',
  meta: 'u-theme--color--base'
};
...
const full = {
  content:
    'u-color--white u-spacing l-grid--7-col l-grid-wrap l-grid-wrap--7-of-7',
  group:
    'u-text-align--center u-flex--align-center u-flex--justify-center u-overlay--dark',
  title:
    'u-font--primary--xl u-space--zero u-flex--justify-center l-grid-item--5-col l-grid-item--m--2-col u-theme--color--dark'
};
...
const inline = {
  ...
  content:
    'u-spacing u-background-color--gray--light u-color--gray u-padding--bottom u-padding--top',
  contentReversed:
...
const inset = {
  ...
  title:
    'u-link-hover--white l-grid-item l-grid-item--m--4-col u-theme--color--dark',
...
const mediaContent = {
  ...
  content:
    'u-spacing u-background-color--gray--light can-be--dark-dark u-color--gray u-border-left--black--at-large u-padding--bottom u-padding--top u-flex--justify-between l-grid-item l-grid-item--s--3-col u-theme--border-color--darker--left',
  meta: 'u-theme--color--base'
};
...
const mediaRow = {
  ...
  seven: true,
  block:
    'l-grid l-grid--7-col l-grid-wrap l-grid-item--3-col l-grid-item--m--2-col l-grid-item--xl--1-col',
  image:
    'u-padding--zero--sides u-space--right l-grid-item--3-col l-grid-item--m--2-col l-grid-item--xl--1-col',
  content:
    'u-spacing u-border--left l-grid-item--3-col l-grid-item--m--2-col l-grid-item--xl--1-col',
...
const longform = {
  type: 'inline',
  block:
    'can-be--dark-dark u-padding--bottom u-padding--top u-spacing--until-medium l-grid--7-col l-grid-wrap l-grid-wrap--6-of-7 u-theme--background-color--darker',
  content:
    'u-spacing u-border--left u-shift--left--1-col--at-large l-grid-item l-grid-item--m--6-col l-grid-item--l--4-col l-grid-item--xl--3-col u-theme--border-color--light--left u-theme--color--lighter',
...
const video = {
  ...
  content:
    'u-color--gray u-border--left u-spacing u-theme--border-color--darker--left',
  title: 'u-font--primary--m u-space--zero u-theme--color--darker'
};
